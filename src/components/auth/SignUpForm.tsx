...
export default function SignUpForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.password || !isChecked) {
      setError("Tous les champs sont obligatoires et vous devez accepter les conditions.");
      setLoading(false);
      return;
    }
      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        <div>
          ...
          <div>
            ...
            <Input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Entrez votre email" />
          </div>

          <div>
            <Label>Email<span className="text-error-500">*</span></Label>
            <Input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Entrez votre email" />
          </div>
